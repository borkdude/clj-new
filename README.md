...
clojure -Ttools install com.github.seancorfield/clj-new '{:git/tag "v1.2.380"}' :as clj-new
...
```clj
{:aliases
 {:new {:extra-deps {com.github.seancorfield/clj-new {:mvn/version "1.2.380"}}
        :exec-fn clj-new/create
        :exec-args {:template "app"}}}}
```
